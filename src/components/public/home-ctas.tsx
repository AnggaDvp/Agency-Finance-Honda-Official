    ...
    <>
      <div className="flex flex-wrap gap-4 pt-3">
        <button
          ...
          className="rounded-lg bg-red-600 px-8 py-3.5 text-sm font-bold uppercase tracking-wider text-white shadow-lg hover:bg-red-700"
        >
          Ajukan Dana BPKB
        </button>
        <button
          ...
          className="rounded-lg border-2 border-red-200 bg-white px-7 py-3.5 text-sm font-bold uppercase tracking-wider hover:border-red-500 hover:text-red-600"
        >
          Ajukan Kredit Motor
        </button>
      </div>
